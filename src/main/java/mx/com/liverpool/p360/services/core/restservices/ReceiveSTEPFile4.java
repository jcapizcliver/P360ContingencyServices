...
/**
 * Servlet implementation class ReceiveSTEPFile4
 */
...
public class ReceiveSTEPFile4 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		java.nio.file.Path fp = java.nio.file.Paths.get(p.toString(), fn, "Gral4_" + new java.text.SimpleDateFormat("yyyyMMddHHmmssSSS").format(new java.util.Date()) + ".xml");
	...
	private void logMe(String message) {
        try (java.io.PrintWriter pw = new java.io.PrintWriter(new java.io.OutputStreamWriter(
                new java.io.FileOutputStream("../logs/receiveFile.log", true)))) {
