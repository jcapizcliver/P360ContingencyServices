...
/**
 * Servlet implementation class KeepFinalMediaAssetURLs
 */
@WebServlet("/public/rt/KeepFinalMediaAssetURLs")
public class KeepFinalMediaAssetURLs extends HttpServlet {
     ...
     */
    public KeepFinalMediaAssetURLs() {
        super();
